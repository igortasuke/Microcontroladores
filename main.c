...
ISR(PCINT0_vect) {
    uint8_t new_value;
    uint8_t chg;
    GPT_Config cfg_debounce = {MODE_CTC, DIVISOR_1024, 195, 8};
...
void motor_run(void){
    switch (currentCoil)
    {
        ...
        case (MICROSTEP2):
            if(cb_achieved){
                gpio_write_group(GPIOD4, 0x1, coil2);
                cb_achieved = 0;
                currentCoil += 1;
            }
        break;
        ...
        case (MICROSTEP3):
            if(cb_achieved){
                gpio_write_group(GPIOD4, 0x1, coil3);
                cb_achieved = 0;
                currentCoil += 1;
            }
        break;
        ...
        case (MICROSTEP4):
            if(cb_achieved){
                gpio_write_group(GPIOD4, 0x1, coil4);
                cb_achieved = 0;
                currentCoil = 0;
            }
        break;
 ...
 */
int main() {
    GPT_Config cfg = {MODE_CTC, DIVISOR_1024, 0xFF, 0x1};
